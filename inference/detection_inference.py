...
class DetectionInference:
    def __init__(self, model, device):
        ...
        self.calib_dataloader = create_fixed_size_dataloader(calib_dataset, 100)
        set_running_statistics(model, self.calib_dataloader, 100)
    ...
    def set_active_subnet(self, **subnet_config):
        ...
        set_running_statistics(self.model, self.calib_dataloader, 100)
